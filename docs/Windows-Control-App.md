...
The application is becoming Tower's primary desktop control surface. It remains
a client: Tower on the Raspberry Pi owns device data, command execution,
automation schedules, and persistent configuration.
